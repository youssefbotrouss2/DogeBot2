...
//-----(YSF Bot by يوسف بطرس Inc.)-----\\
//-----(Youtube Channel: YSF BOT)-----\\
//-----(Whatsapp number: +201289267791)-----\\
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*YSF BOT*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/G3a3AQndqS5J45eD7zznXF', "groupName": `Youssef Bot Inc.`, "footerText": "*YSF BOT*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "YSF BOT"; break;
                case 1: jamss = "YSF BOT"; break;
                case 2: jamss = "YSF BOT"; break;
                case 3: jamss = "YSF BOT"; break;
                case 4: jamss = "YSF BOT"; break;
                case 5: jamss = "YSF BOT"; break;
                case 6: jamss = "YSF BOT"; break;
                case 7: jamss = "YSF BOT"; break;
                case 8: jamss = "YSF BOT"; break;
                case 9: jamss = "YSF BOT"; break;
                case 10: jamss = "YSF BOT"; break;
                case 11: jamss = "YSF BOT"; break;
                case 12: jamss = "YSF BOT"; break;
                case 13: jamss = "YSF BOT"; break;
                case 14: jamss = "YSF BOT"; break;
                case 15: jamss = "YSF BOT"; break;
                case 16: jamss = "YSF BOT"; break;
                case 17: jamss = "YSF BOT"; break;
                case 18: jamss = "YSF BOT"; break;
                case 19: jamss = "YSF BOT"; break;
                case 20: jamss = "YSF BOT"; break;
                case 21: jamss = "YSF BOT"; break;
                case 22: jamss = "YSF BOT"; break;
                case 23: jamss = "YSF BOT"; break;
            }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*YSF BOT*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `YSF BOT`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/201289267791`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*YSF BOT*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('https://github.com/DGYoussef')
}
if(isButton == 'ytm'){
...
${z}🐶 ${prefix}animemenu${z}
    watch how you can install this bot in your whatsapp: https://youtube.com/channel/UCiF_A2emP3bZ48tyLZZ4NXg
┗━━━━━━━━━━━━━━━━━`
buttons = [
...
stamtus =`❏ 「 \`\`\`MAKER MENU\`\`\` 」
────────────────────
_example: ${prefix}throne Youssef_
────────────────────
🐶 ${prefix}write 「 text 」
🐶 ${prefix}throne 「 text 」
🐶 ${prefix}logoff 「 text 」
...
──────────────────
*👇SCRIPT GITHUB LINK👇*
https://github.com/DGYoussef/YSF BOT2
_BASE : Youssef Bot Inc._
_ORI SCRIPT : YSF BOT Version 2_
_OWNER : ${NamaOwner}_
⍟ ────────────────── ⍟`
buttons = [
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `YSF BOT Script`,
          "url": "https://github.com/youssefbotrouss2/DogeBot2"
        },
        "index": 0
      }
    ]
...
const btnbc = {
    ...
    footerText: '*_YSF BOT BROADCAST_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`YSF BOT`}, MessageType.location)
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY YSF BOT`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `YSF BOT`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `YSF BOT`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
